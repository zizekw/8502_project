...
plot(glm_perf)
# Calcualte presion hardcoded at this point, improve later
model_presion = 9059/(9059+126)
model_recall = 9059/(9059+908)
model_presion
model_recall
```
...
model_presion = 9059/(9059+123)
model_recall = 9050/(9050+907)
model_presion
model_recall
```
...
model_presion = 9064/(9064+121)
model_recall = 9064/(9064+913)
model_presion
model_recall
```
...
model_presion = 9068/(9068+117)
model_recall = 9068/(9068+917)
model_presion
model_recall
```
...
model_Precision = 9060 / (9060 + 125)
model_recall = 9060/(9060+906)
model_Precision
model_recall
```
